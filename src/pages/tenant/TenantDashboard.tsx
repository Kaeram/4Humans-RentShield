...
const quickStats = [
    { label: 'Total Reports', value: '4', icon: FileText, color: 'text-primary-600 bg-primary-100' },
    { label: 'In Progress', value: '2', icon: Clock, color: 'text-warning-600 bg-warning-100' },
    { label: 'Resolved', value: '1', icon: TrendingUp, color: 'text-success-600 bg-success-100' },
    { label: 'Escalated', value: '1', icon: AlertCircle, color: 'text-danger-600 bg-danger-100' },
]
            ...
            <main className="pt-24 pb-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                        ...
                        <Link to="/tenant/report" className="btn-primary">
                    ...
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-4 border border-primary-100 mb-8"
                    >
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-neutral-900">Your Identity is Protected</h3>
                    ...
                    <div className="card p-0 overflow-hidden">
                        ...
                        <div className="flex items-center gap-4 p-4 border-b border-neutral-100">
                            <h2 className="font-semibold text-neutral-900">Your Issues</h2>
                        ...
                        <div className="divide-y divide-neutral-100">
                            {isLoading ? (
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    <Link to="/tenant/report" className="btn-primary mt-4 inline-flex">
                                        <Plus className="h-4 w-4 mr-2" />
